...
Tein ensin haitallisen elf-tiedoston

<img width="306" height="70" alt="image" src="https://github.com/user-attachments/assets/4051356c-3712-479d-ba7e-8f2fee2fe879" />

Tämän jälkeen msfconsole ja ```use exploit/multi/handler``` ja vaihdoin asetuksia, vaihtamalla **set LHOST** KALI (hyökkääjä) IP ja **set LPORT** portti jota kuunnellaan.

<img width="910" height="477" alt="image" src="https://github.com/user-attachments/assets/defcc68d-9a71-4124-9575-9f5998f51b75" />


* Tähän kohtaan pääsin ennen ongelmia

Ongelmaksi osottautui luultavasti se etten ollut tehnyt tulimuuriin reikää portille, joten en pystynyt levittämään haittaohjelmaa Metasploitiin.

Joten tein tulimuuriin reijän portille 8080 ja
