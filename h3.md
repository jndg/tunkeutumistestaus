...
<img width="1318" height="580" alt="image" src="https://github.com/user-attachments/assets/248e225c-ee41-491f-a265-0064d718b6a6" />
 ...
 Lisätään Zapissa sivustolla käytettyyn kuvaan ```/etc/passwd``` joka muodostaa absoluuttisen polun

Tavoitteena on ohittaa ```../``` suodatus

File path travelsal, travesal sequences stripped non-recursively 

<img width="1307" height="767" alt="image" src="https://github.com/user-attachments/assets/16aee668-4200-4086-a3b4-16f206aa3939" />

Jos palvelin muuttaa ```../``` yhdesti voidaan kokeilla ohittaa suodatus kokeilemalla ```....//....//....//etc/passwd```
